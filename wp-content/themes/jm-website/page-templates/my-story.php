		...
		<div class="container">
			<div class="row">
				<div class="col-12 col-md-7">
					...
					<p>
						Leadership is not always inborn and that was the biggest learning for me growing up as a
						serviceman’s daughter. Because leadership starts with leading yourself, the discipline of getting
						yourself to do things you ought to be doing. All through my career in banking spanning almost two decades, I have seen CEO’s and first-generation entrepreneurs either make it or bring it all to the ground and the key factor that set them apart was self-leadership.<br/><br/> I saw subordinates, contemporaries, and superiors struggling with the ‘treadmill syndrome’, running frantically but getting nowhere, and that led me to my ardor - Coaching. Although banking for me was an accomplishment, influencing people in an inclusive environment was my passion.
						<br/><br/>
						In 2011, at the peak of my career, I decided to graduate as a Certified Coach and groomed my instincts further by programs in Facilitation and Self Leadership. Today, I catalyze individuals in achieving an attuned and steady
...
<script>
	...
	if (link.indexOf('#express') !== -1) {
		$('html, body').animate({
			scrollTop: $('#express').offset().top - 50
		}, 1000);
	}
	if (link.indexOf('#examine') !== -1) {
		$('html, body').animate({
			scrollTop: $('#examine').offset().top - 50
		}, 1000);
	}
	if (link.indexOf('#evolve') !== -1) {
		$('html, body').animate({
			scrollTop: $('#evolve').offset().top - 50
		}, 1000);
	}
</script>